cmd_crypto/shash.o := arm-xilinx-linux-gnueabi-gcc -Wp,-MD,crypto/.shash.o.d  -nostdinc -isystem /cad/x_15/SDK/2015.1/gnu/arm/lin/bin/../lib/gcc/arm-xilinx-linux-gnueabi/4.9.1/include -I/cad/digilent/arch/arm/include -Iarch/arm/include/generated -Iinclude  -I/cad/digilent/include -include /cad/digilent/include/linux/kconfig.h  -I/cad/digilent/crypto -Icrypto -D__KERNEL__ -mlittle-endian   -I/cad/digilent/arch/arm/mach-zynq/include -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -Werror-implicit-function-declaration -Wno-format-security -fno-delete-null-pointer-checks -Os -marm -fno-dwarf2-cfi-asm -mabi=aapcs-linux -mno-thumb-interwork -funwind-tables -D__LINUX_ARM_ARCH__=7 -march=armv7-a -msoft-float -Uarm -Wframe-larger-than=1024 -fno-stack-protector -Wno-unused-but-set-variable -fomit-frame-pointer -Wdeclaration-after-statement -Wno-pointer-sign -fno-strict-overflow -fconserve-stack -DCC_HAVE_ASM_GOTO    -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(shash)"  -D"KBUILD_MODNAME=KBUILD_STR(crypto_hash)" -c -o crypto/.tmp_shash.o /cad/digilent/crypto/shash.c

source_crypto/shash.o := /cad/digilent/crypto/shash.c

deps_crypto/shash.o := \
    $(wildcard include/config/net.h) \
    $(wildcard include/config/proc/fs.h) \
  /cad/digilent/include/crypto/scatterwalk.h \
  /cad/digilent/arch/arm/include/asm/kmap_types.h \
  /cad/digilent/include/crypto/algapi.h \
  ...
  /cad/digilent/include/crypto/internal/hash.h \
