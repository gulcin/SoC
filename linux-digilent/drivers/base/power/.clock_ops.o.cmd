cmd_drivers/base/power/clock_ops.o := arm-xilinx-linux-gnueabi-gcc -Wp,-MD,drivers/base/power/.clock_ops.o.d  -nostdinc -isystem /cad/x_15/SDK/2015.1/gnu/arm/lin/bin/../lib/gcc/arm-xilinx-linux-gnueabi/4.9.1/include -I/cad/digilent/arch/arm/include -Iarch/arm/include/generated -Iinclude  -I/cad/digilent/include -include /cad/digilent/include/linux/kconfig.h  -I/cad/digilent/drivers/base/power -Idrivers/base/power -D__KERNEL__ -mlittle-endian   -I/cad/digilent/arch/arm/mach-zynq/include -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -Werror-implicit-function-declaration -Wno-format-security -fno-delete-null-pointer-checks -Os -marm -fno-dwarf2-cfi-asm -mabi=aapcs-linux -mno-thumb-interwork -funwind-tables -D__LINUX_ARM_ARCH__=7 -march=armv7-a -msoft-float -Uarm -Wframe-larger-than=1024 -fno-stack-protector -Wno-unused-but-set-variable -fomit-frame-pointer -Wdeclaration-after-statement -Wno-pointer-sign -fno-strict-overflow -fconserve-stack -DCC_HAVE_ASM_GOTO    -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(clock_ops)"  -D"KBUILD_MODNAME=KBUILD_STR(clock_ops)" -c -o drivers/base/power/.tmp_clock_ops.o /cad/digilent/drivers/base/power/clock_ops.c

source_drivers/base/power/clock_ops.o := /cad/digilent/drivers/base/power/clock_ops.c
...
deps_drivers/base/power/clock_ops.o := \
  ...
  /cad/digilent/include/linux/pm_clock.h \
