cmd_drivers/scsi/sd.o := arm-xilinx-linux-gnueabi-gcc -Wp,-MD,drivers/scsi/.sd.o.d  -nostdinc -isystem /cad/x_15/SDK/2015.1/gnu/arm/lin/bin/../lib/gcc/arm-xilinx-linux-gnueabi/4.9.1/include -I/cad/digilent/arch/arm/include -Iarch/arm/include/generated -Iinclude  -I/cad/digilent/include -include /cad/digilent/include/linux/kconfig.h  -I/cad/digilent/drivers/scsi -Idrivers/scsi -D__KERNEL__ -mlittle-endian   -I/cad/digilent/arch/arm/mach-zynq/include -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -Werror-implicit-function-declaration -Wno-format-security -fno-delete-null-pointer-checks -Os -marm -fno-dwarf2-cfi-asm -mabi=aapcs-linux -mno-thumb-interwork -funwind-tables -D__LINUX_ARM_ARCH__=7 -march=armv7-a -msoft-float -Uarm -Wframe-larger-than=1024 -fno-stack-protector -Wno-unused-but-set-variable -fomit-frame-pointer -Wdeclaration-after-statement -Wno-pointer-sign -fno-strict-overflow -fconserve-stack -DCC_HAVE_ASM_GOTO    -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(sd)"  -D"KBUILD_MODNAME=KBUILD_STR(sd_mod)" -c -o drivers/scsi/.tmp_sd.o /cad/digilent/drivers/scsi/sd.c

source_drivers/scsi/sd.o := /cad/digilent/drivers/scsi/sd.c
...
deps_drivers/scsi/sd.o := \
  ...
  /cad/digilent/include/linux/hdreg.h \
  ...
  /cad/digilent/include/linux/blkpg.h \
  /cad/digilent/include/linux/delay.h \
  /cad/digilent/arch/arm/include/asm/delay.h \
  /cad/digilent/include/linux/string_helpers.h \
  ...
  /cad/digilent/include/scsi/scsicam.h \
  /cad/digilent/drivers/scsi/sd.h \
