cmd_net/ipv4/udp.o := arm-xilinx-linux-gnueabi-gcc -Wp,-MD,net/ipv4/.udp.o.d  -nostdinc -isystem /cad/x_15/SDK/2015.1/gnu/arm/lin/bin/../lib/gcc/arm-xilinx-linux-gnueabi/4.9.1/include -I/cad/digilent/arch/arm/include -Iarch/arm/include/generated -Iinclude  -I/cad/digilent/include -include /cad/digilent/include/linux/kconfig.h  -I/cad/digilent/net/ipv4 -Inet/ipv4 -D__KERNEL__ -mlittle-endian   -I/cad/digilent/arch/arm/mach-zynq/include -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -Werror-implicit-function-declaration -Wno-format-security -fno-delete-null-pointer-checks -Os -marm -fno-dwarf2-cfi-asm -mabi=aapcs-linux -mno-thumb-interwork -funwind-tables -D__LINUX_ARM_ARCH__=7 -march=armv7-a -msoft-float -Uarm -Wframe-larger-than=1024 -fno-stack-protector -Wno-unused-but-set-variable -fomit-frame-pointer -Wdeclaration-after-statement -Wno-pointer-sign -fno-strict-overflow -fconserve-stack -DCC_HAVE_ASM_GOTO    -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(udp)"  -D"KBUILD_MODNAME=KBUILD_STR(udp)" -c -o net/ipv4/.tmp_udp.o /cad/digilent/net/ipv4/udp.c

source_net/ipv4/udp.o := /cad/digilent/net/ipv4/udp.c
...
deps_net/ipv4/udp.o := \
  ...
  /cad/digilent/include/linux/igmp.h \
  ...
  /cad/digilent/include/trace/events/udp.h \
  /cad/digilent/include/trace/define_trace.h \
  /cad/digilent/include/trace/events/skb.h \
  /cad/digilent/net/ipv4/udp_impl.h \
  /cad/digilent/include/net/udp.h \
  /cad/digilent/include/net/udplite.h \
  /cad/digilent/include/net/ip6_checksum.h \
  /cad/digilent/include/net/protocol.h \
